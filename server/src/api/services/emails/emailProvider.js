  ...
  email
    .send({
      ...
      locals: {
        ...
        // passwordResetUrl should be a URL to easyowe that displays a view where they
        // can enter a new password along with passing the resetToken in the params
        passwordResetUrl: `https://easyowe/new-password/view?resetToken=${passwordResetObject.resetToken}`,
      },
    })
